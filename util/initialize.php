...
//    require_once __DIR__."/../modal/InventoryProductionProduct.php";
    ...
    //new_class
    require_once __DIR__."/../modal/DeviceFault.php";
    require_once __DIR__."/../modal/PossibleSolution.php";
    require_once __DIR__."/../modal/CollectedAccessories.php";
    require_once __DIR__."/../modal/DeviceModel.php";
    require_once __DIR__."/../modal/DeviceRepair.php";
    require_once __DIR__."/../modal/LocationNumber.php";
    require_once __DIR__."/../modal/Brand.php";
    require_once __DIR__."/../modal/Remainder.php";
    require_once __DIR__."/../modal/RepairStatus.php";
    require_once __DIR__."/../modal/RepairDeviceFault.php";
    require_once __DIR__."/../modal/RepairPossibleSolution.php";
    require_once __DIR__."/../modal/RepairCollectedAccessories.php";
    require_once __DIR__."/../modal/JobCloseStatus.php";
    require_once __DIR__."/../modal/JobClose.php";
    require_once __DIR__."/../modal/PaymentClose.php";
    require_once __DIR__."/../modal/Allocation.php";   
    require_once __DIR__."/../modal/Discription.php";
    require_once __DIR__."/../modal/Location.php";
?>
