                    ...
                    <div class="x_content">
                        <div class="container-fluid divBackTopTable ">
                            <div class="form-group col-md-4 col-sm-4 col-xs-12 ">
                                ...
                                <div class="ui-widget">
                                    <select class="form-control selectpicker"  data-live-search="true" id="cmbFilter" name="filter_id" required="">
                                        <!-- <option selected="" value="all">All Invoices</option> -->
                                        <!-- <option value="retail">Retail Invoices</option> -->
                                        <option selected disabled>Select Customer</option>
                                        <?php
                                        foreach (Customer::find_all_name() as $customer) {
                                            ?>
                    ...
                    <div class="x_content">
                        <form id="form" action="proccess/payment_proccess.php" method="post" class="form-horizontal form-label-left" >
                            <div class="container-fluid ">
                                ...
                                <div class="form-group">
                                    <label>Amount</label>
                                    <input type="text" class="form-control" placeholder="Amount" id="txtAmount" name="amount" value="<?php echo $payment->amount; ?>" required="">
                                </div>
                                <div class="form-group">
                                ...
                                <div id="divCheque" style="display: none;">
                                    <div class="form-group divBackTopTable col-md-12 col-sm-12 col-xs-12 ">
                                        ...
                                        <!--                                        <div class="col-md-12 col-sm-12 col-xs-12" >
                                                                                    <div class="form-group">
                                                                                        <label>Allocated Cheque Value For This Invoice</label>
                                                                                        <input type="text" class="form-control" placeholder="Cheque Value" name="c_allocated_amount" id="txtChequeAllocatedAmount">
                                                                                    </div>
                                                                                </div>-->
                                        <!--</div>-->
                                    </div>
...
//////////////////////////////////////////////////    
    ...
    function getErrors() {
        ...
        if (element_value !== "" && Validation.validatePrice(element_value)) {
            if (element_value > 0) {
                var selected_total=getTotal();
                if (Number(element_value) < selected_total || Number(element_value) > selected_total) {
                    errors.push("Amount is different than selected invoices payments total");
                    element.css({"border": "1px solid red"});
                } else {
                    element.css({"border": "1px solid #ccc"});
                }
