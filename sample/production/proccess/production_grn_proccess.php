...
if (isset($_POST["save"])) {
    ...
    $batch = new Batch();
    $batch->code = $_POST["b_code"];
    $batch->product_id = $_POST["product_id"];
    // $batch->mfd = $_POST["b_mfd"];
    // $batch->exp = $_POST["b_exp"];
    $batch->cost = $_POST["b_cost"];
    $batch->retail_price = $_POST["b_retail_price"];
    $batch->wholesale_price = $_POST["b_wholesale_price"];
    ...
    try {
        ...
        $production_product->production_id = $production->id;
