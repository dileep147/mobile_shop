    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2 id="title"><?php echo (empty($product->id)) ? 'Add' : 'Edit'; ?> Location</h2>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <div class="x_content">
                            <form id="form" action="proccess/deliverer_proccess.php" method="post" class="form-horizontal form-label-left" >
                                ...
                                if(isset($_GET['id'])){
                                    ?>
                                    <input type="hidden" class="form-control" id="txtId" name="update" value="1" />
                                    <?php
                                }
                                ?>
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="txtName" name="name" placeholder="Location Name" value="<?php echo $deliverer->name; ?>" required="" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>Location Address</label>
                                        <input type="text" id="txtNumber" name="number" placeholder="Location Address" value="<?php echo $deliverer->number; ?>" required="" class="form-control">
                                    </div>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class=" col-md-4 col-sm-4 col-xs-12">
                                ...
                                if($deliverer->id){
                                    ...
                                    <button id="btnUpdate" type="button" name="update" class="btn btn-block btn-success"><i class="fa fa-floppy-o"></i> Update</button>
