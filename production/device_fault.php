...
if (isset($_GET["id"])) {
    $id = $_GET["id"];
    if($category = DeviceFault::find_by_id($id)){

    }else{
        $category = new DeviceFault();
    }
}else{
    $category = new DeviceFault();
}
    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2 id="title" style="font-weight:900;"><?php echo (empty($category->id)) ? 'Add' : 'Edit'; ?> Device Fault</h2>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <form id="formCategory" action="proccess/device_fault_proccess.php" method="post" class="form-horizontal form-label-left" >
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <input type="hidden" class="form-control" id="txtId" name="id" value="<?php echo $category->id; ?>" />
                                <div class="form-group">
                                    <label>Fault Name</label>
                                    <input type="text" class="form-control" placeholder="Fault Name" id="txtName" name="name" value="<?php echo $category->name; ?>" required="">
                                </div>
                                ...
                                <div class="modal-footer col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class=" col-md-4 col-sm-4 col-xs-12">
                                        <a href="device_fault.php"><button type="button" name="reset" class="btn btn-block btn-primary"><i class="fa fa-history"></i> Reset</button></a>
                                    </div>
                                </div>
                            </div>
                        </form>
