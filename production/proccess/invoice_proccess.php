...
if (isset($_POST["inventory_request"])) {
    ...
    $deliverer_inventory = DelivererInventory::find_by_id($deliverer_inventory_id);
    $batch = $deliverer_inventory->inventory_id()->batch_id();
...
if (isset($_POST["add_product"])) {
    $deliverer_inventory_id = $_POST['deliverer_inventory_id'];
    $inventory_id = DelivererInventory::find_by_id($deliverer_inventory_id)->inventory_id;
    $price = $_POST['price'];
    $qty = $_POST['qty'];
//    $unit_discount = (!empty($_POST['unit_discount']))? $_POST['unit_discount']:0;
    ...
    $invoice_inventory["deliverer_inventory_id"] = $deliverer_inventory_id;
