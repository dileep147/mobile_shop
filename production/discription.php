...
if (!(isset($_POST["id"]) && $discription = Discription::find_by_id($_POST["id"]))) {
    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2 id="title"><?php echo (empty($discription->id)) ? 'Add' : 'Edit'; ?> Discription</h2>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <form id="formRole" action="proccess/discription_process.php" method="post" class="form-horizontal form-label-left" >
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <input type="hidden" class="form-control" id="txtId" name="id" value="<?php echo $discription->id; ?>" />
                                
                                <div class="form-group">
                                    <label>Discription</label>
                                    <textarea class="form-control" name="discription" ><?php echo $discription->discription; ?></textarea>
                                </div>

                                <div class="form-group">
                                    <label>Price Discription</label>
                                    <textarea class="form-control" name="price_discription" ><?php echo $discription->price_discription; ?></textarea>
                                </div>
                                ...
                                <div class="modal-footer col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class=" col-md-4 col-sm-4 col-xs-12" style="display: <?php echo (empty($discription->id)) ? 'none' : 'initial'; ?>">
                                    ...
                                    <div class=" col-md-4 col-sm-4 col-xs-12">
                                        <a href="discription.php"><button type="button" name="reset" class="btn btn-block btn-primary"><i class="fa fa-history"></i> Reset</button></a>
                                    </div>
                                </div>
...
//        });
    ...
    $("#btnSave").click(function () {
        var id = <?php echo ($discription->id) ? 1 : 0; ?>;
