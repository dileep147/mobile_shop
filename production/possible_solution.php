...
if (isset($_GET["id"])) {
    $id = $_GET["id"];
    if($category = PossibleSolution::find_by_id($id)){

    }else{
        $category = new PossibleSolution();
    }
}else{
    $category = new PossibleSolution();
}
    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2 id="title" style="font-weight:900;"><?php echo (empty($category->id)) ? 'Add' : 'Edit'; ?> Possible Solution</h2>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <form id="formCategory" action="proccess/possible_solution_process.php" method="post" class="form-horizontal form-label-left" >
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <input type="hidden" class="form-control" id="txtId" name="id" value="<?php echo $category->id; ?>" />
                                <div class="form-group">
                                    <label>Possible Solution</label>
                                    <input type="text" class="form-control" placeholder="Possible Solution" id="txtName" name="name" value="<?php echo $category->name; ?>" required="">
                                </div>
                                ...
                                <div class="modal-footer col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class=" col-md-4 col-sm-4 col-xs-12">
                                        <a href="possible_solution.php"><button type="button" name="reset" class="btn btn-block btn-primary"><i class="fa fa-history"></i> Reset</button></a>
                                    </div>
                                </div>
                            </div>
                        </form>
