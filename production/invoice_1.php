                    ...
                    <form id="form" action="proccess/invoice_proccess.php" method="post" class="form-horizontal form-label-left" >
                        <div class="x_title">
                            ...
                            <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                ...
                                <input type="text" id="txtCode" name="code" class="form-control" placeholder="Enter Code" value="" required="required" />
                            </div>
                            <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                <label>Date</label>
                    ...
                    <!--style="display: <?php echo ($return_invoice) ? 'disabled' : ''; ?>"-->
                        ...
                        <div id="divInvType" class="x_content"  >
                            ...
                            <div class="tab-content">
                                ...
                                <div id="divOrder" class="tab-pane fade in <?php echo(isset($customer_order)) ? 'in active' : ''; ?>">
                                    <br/>
                                    <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                        <label>Customer</label>
                                        ...
                                        <select id="cmbOrder" name="order_id" class="form-control">
                                            ...
                                            foreach (CustomerOrder::find_all() as $db_customer_order) {
                                                if ($db_customer_order->id == $customer_order->id) {
                                                    ?>
                                                    <option selected="" value="<?php echo $db_customer_order->id; ?>"><?php echo $db_customer_order->code; ?></option>
                                                    <?php
                                                } else {
                                                    ?>
