...
require_once './../util/initialize.php';
  ...
  if(isset($_GET['id']) || isset($_GET['id'])){
    ...
    $job_close_data=JobClose::find_by_id($_GET['id']);
...
<div class="container-fluid">
 ...
 <table class="table table-striped">
   ...
   <tr >
    ...
    <tr >
     <td  style="text-align: center;">Warranty :<?php echo $job_close_data->warranty; ?></td>
     ...
     <td  style="text-align: center;"><?php  
          ...
          echo "<br>";
          echo "<td>";
                  foreach (RepairPossibleSolution::find_all_by_possible_solution($repair_data->id) as $possible_solution_data ) {
...
<div class="col-xs-3" >
    ...
    <table style="width:100%;"> 
        ...
        <tr  style="border:1px solid;">  
         ...
         <tr  style="border:1px solid;">  
            <td>Balance</td>
            <td>: <?php echo number_format(($repair_data->advanced_payment)-($repair_data->job_cost)-($job_close_data->amount),2); ?></td>
        </tr>  
