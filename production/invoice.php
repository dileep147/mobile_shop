                            ...
                            <div class="form-group col-md-12 col-sm-12 col-xs-12 ">
                                ...
                                <select class="form-control selectpicker"  data-live-search="true" id="cmbProduct" name="product_id" >
                                    ...
                                    foreach (Product::find_all_by_order_by_name() as $product) {
                                        ?>
                                        <option value="<?php echo $product->id; ?>"><?php echo $product->name; ?> | <?php echo $product->category_id()->name; ?> (Qty: <?php echo available($deliverer->id,$product->id); ?>) <?php batch($product->id); ?></option>
                                        <?php
                                    }
                                    ?>
                                </select>
