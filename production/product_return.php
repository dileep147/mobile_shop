                    ...
                    <div class="x_content">
                        <form id="form" action="proccess/product_return_proccess.php" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left" >
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control selectpicker"  data-live-search="true" id="cmbCustomer" name="customer_id">
                    ...
                    <div class="x_content">
                        <div class="container-fluid divBackTopTable ">
                            <div class="form-group col-md-10 col-sm-10 col-xs-10 ">
                                ...
                                <select class="form-control selectpicker"  data-live-search="true" id="cmbBatch" name="batch_id">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content" style="text-align: right;">
                        <button id="btnSave1" type="button" class="btn btn-success">Next <i class="fa fa-chevron-circle-right"></i></button>
                        <!-- <button id="btnSave" type="button" class="btn btn-success">Next Invoice <i class="fa fa-chevron-circle-right"></i></button> -->
                    </div>
                </div>
            </div>
        </div>
