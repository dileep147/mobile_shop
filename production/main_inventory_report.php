                    ...
                    <div class="x_content">
                        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <?php
                                foreach (Batch::find_all() as $db_batch) {
                                    $inventory=new Inventory();
                                    $inventory->batch_id=$db_batch->id;
                                    $total=0;
                                    foreach (Inventory::find_all_calculated_qty_batch_id($db_batch->id) as $db_inventory) {
                                    ...
                                    <tr>
                                        ...
                                        <!--<td><?php // echo $inventory->inventory_type_id()->name; ?></td>-->
                                        <td>
