...
//if (!(isset($_POST["id"]) && $brand = Batch::find_by_id($_POST["id"]))) {
//    $brand = new Batch();
//}

if (!(isset($_POST["id"]) && $brand = Brand::find_by_id($_POST["id"]))) {
    $brand = new Brand();
}
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form id="formBatch" action="proccess/brand_process.php" method="post" class="form-horizontal form-label-left" >
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <input type="hidden" class="form-control" id="txtId" name="id" value="<?php echo $brand->id; ?>" />
                                <div class="form-group">
                                    <label>Brand</label>
                                    <input type="text" class="form-control" placeholder="Name" id="txtid" name="name" value="<?php echo $brand->name; ?>" required="">
                                </div>
                                ...
                                <div class="modal-footer col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class=" col-md-4 col-sm-4 col-xs-12">
                                        <a href="brand.php"><button type="button" name="reset" class="btn btn-block btn-primary"><i class="fa fa-history"></i> Reset</button></a>
                                    </div>
                                </div>
