                            ...
                            <div class="row invoice-info">
                                <div class="col-sm-4 invoice-col">
                                    ...
                                    <address>
                                        ...
                                        <br><?php echo ProjectConfig::$address; ?>
                                        <br>Phone: <?php echo ProjectConfig::$tel; ?>
                                    </address>
                                </div>
                                <!-- /.col -->
                                <div class="col-sm-4 invoice-col">
                                    ...
                                    <table class="table table-striped">
                                        <thead>
                                            <tr>
												...
												<th style='text-align:right;'>Paid Cheque Amount</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                foreach ($payment_invoices as $payment_invoice){										
                                                    ...
                                                    if(!empty($invoice->customer_id)){
                                                        $customer_name = Customer::find_by_id($invoice->customer_id);
                                                        $customer = $customer_name->name; 
                                                    }else{
                                                       $customer = "Retail Invoice";  
                                                    }
                                                    
                                                    echo "<tr>";  
                                                    echo "<td>".$inv->code."</td>"; 
                                                    echo "<td style='text-align:right;'>".$customer."</td>";
                                                    echo "<td style='text-align:center;'>".$inv->date_time."</td>";
                                                    echo "<td style='text-align:right;'>".$inv->invoice_type_id()->name."</td>";
                                                    echo "<td style='text-align:right;'>".$inv->gross_amount."</td>";
                                                    echo "<td style='text-align:right;'>".$inv->net_amount."</td>";
                                                    echo "<td style='text-align:right;'>".$inv->balance."</td>";
