...
//                                            $grnp = GRNProduct::find_by_batch_id($batch->id);
                                            ...
                                            <option value="<?php echo $batch->id; ?>"><?php echo $batch->product_id()->name . " | Batch:" . $batch->code . ""; ?></option>
                                            <?php
                                        }
                                        ?>
                                    </select>
            ...
            success: function (data) {
                ...
                $.each(data, function (index, value) {
                    if (index !== "total") {
                        ...
                        trHTML += "<tr id='" + data[index]["index"] + "'><td>" + batch + "</td><td>" + value["batch_id"]["product_id"]["name"] + "</td><td>" + data[index]["qty"] + "</td><td>" + value["batch_id"]["cost"] + "</td><td>" + value["line_total"] + "</td><td class='col-sm-2'>" + btnEdit + btnClose + "</td></tr>";
                    }
                });
