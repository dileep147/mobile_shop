    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <a href="inventory.php"><button id="btnNew" type="button" class="btn btn-round btn-primary" data-toggle="modal" data-target=".bs-example-modal-lg"><i class="glyphicon glyphicon-plus"></i> Add New</button></a>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                            ...
                            <tbody>
                                ...
                                foreach (Inventory::find_all_calculated_qty() as $inventory) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $inventory->qty;

                                        if($inventory->qty < 0){

                                        //   $newinv = Inventory::find_by_id($inventory->id);
                                        //   $current = $newinv->qty;
                                        //   $newqty = $current - $inventory->qty;
                                        //   $newinv->qty = $newqty;
                                        //   $newinv->save();
                                        //   echo " cleaned";

                                            // reverse
                                            // $newdel = new DelivererInventory();
                                            // $newdel->inventory_id = $inventory->id;
                                            // $newdel->qty = $inventory->qty;
                                            // $newdel->deliverer_id = 6;
                                            // $newdel->save();
                                            // echo "saved";
                                      }
