    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_panel">
                    <div class="x_title">
                        <h2 id="title"><?php echo (empty($product->id)) ? 'Add' : 'Edit'; ?> Location Inventory</h2>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <div class="x_content">
                        ...
                        <div class="container-fluid divBackTopTable">
                            <div class="col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control selectpicker"  data-live-search="true" id="cmbInventory" name="inventory_id" required="">
                                        ...
                                        foreach (Inventory::find_all_calculated_qty() as $inventory)  {
                                            ?>
                                            <option value="<?php echo $inventory->id; ?>"><?php echo $inventory->batch_id()->product_id()->name." | Batch:".$inventory->batch_id()->code." | Qty:".$inventory->qty; ?> </option>
                                            <?php
                                        }
                                        ?>
                                    </select>
